                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left"    method="post" action="{{ route('explayout.store') }}">
                                {{ csrf_field() }}
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input value="{{ old('exp_nome') }}"  type="text" id="exp_nome" name="exp_nome" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
