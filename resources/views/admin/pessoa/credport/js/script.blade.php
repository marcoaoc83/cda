...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#pnCredPort #btEditar').click(function () {
            ...
            $('#pnCredPort #formEditar #INSCRMUNID').val(INSCRMUNID);
            $('#pnCredPort #formEditar #INSCRMUNNR').val(INSCRMUNNR);
            $('#pnCredPort #formEditar #ORIGTRIBID').val(ORIGTRIBID);
            $('#pnCredPort #formEditar #INICIODT').val(INICIODT);
            $('#pnCredPort #formEditar #TERMINODT').val(TERMINODT);
            $('#pnCredPort #formEditar #SITUACAO').val(SITUACAO);
            var ativo=false;
            if(SITUACAO==1) ativo=true;

            if($( '#pnCredPort #formEditar #SITUACAO' ).prop("checked") !=ativo){
                $( '#pnCredPort #formEditar #SITUACAO' ).trigger("click");
            }
        ...
        $('#pnCredPort #formEditar').on('submit', function (e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                data:formData,
                url: '{{ url('admin/credport/') }}'+'/' +$('#pnCredPort #formEditar #INSCRMUNID').val(),
