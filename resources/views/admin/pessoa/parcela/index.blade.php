<div class="x_panel" id="pnParcela">
    <div class="x_title">
        <h2>Parcelas<small> *(Para inserir, selecione uma {{App\Models\RegTab::where('REGTABSG','AbDocument')->first()->REGTABNM}})</small></h2>
    ...
    <div class="x_content x_title profile_title">
        <a class="btn btn-default btn-xs disabled" id="btInserir"  data-toggle="modal" data-target="#myModalParcela">
