        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Listagem de Legislação</h2>
                            <a href="{{route('legislacao.create')}}" style="margin-left: 15px" type="button" class="btn btn-success btn-sm ">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                responsive: true,
                ajax: '{{ route('legislacao.getdata') }}',
                columns: [
                    {data: 'leg_id', name: 'leg_id'},
                    {data: 'leg_titulo', name: 'leg_titulo'},
