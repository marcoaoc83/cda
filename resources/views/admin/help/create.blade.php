        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Dados da Legislação <small></small></h2>
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" method="post" action="{{ route('help.store') }}"  enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="help_titulo">Título <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input value="{{ old('help_titulo') }}" id="help_titulo" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="help_titulo"  required="required" type="text">
                                    </div>
                                </div>

                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="help_formulario">Formulário <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input value="{{ old('help_formulario') }}" id="help_formulario" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="help_formulario"  required="required" type="text">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea name="help_texto" id="help_texto" rows="200" class="resizable_textarea form-control">{{ old('help_texto') }}</textarea>
                                    </div>
                                </div>
