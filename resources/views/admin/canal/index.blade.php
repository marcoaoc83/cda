        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Listagem de Canais</h2>
                            <a href="{{route('canal.inserirGet')}}" style="margin-left: 15px" type="button" class="btn btn-success btn-sm ">
        ...
        function deleteCanal(dataId) {
            swal({
                ...
                $.ajax({
                    ...
                    url: '{{ url('admin/canal/deletar') }}' + '/' + dataId,
