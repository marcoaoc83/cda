                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left"    method="post" action="{{ route('implayout.store') }}">
                                {{ csrf_field() }}
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input value="{{ old('LayoutSg') }}" id="LayoutSg" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="LayoutSg"  required="required" type="text">
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input value="{{ old('LayoutNm') }}"  type="text" id="LayoutNm" name="LayoutNm" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
