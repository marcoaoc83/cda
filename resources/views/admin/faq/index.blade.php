        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Listagem de Faq</h2>
                            <a href="{{route('faq.create')}}" style="margin-left: 15px" type="button" class="btn btn-success btn-sm ">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('.datatable').DataTable({
                ...
                serverSide: true,
                responsive: true,
                ajax: '{{ route('faq.getdata') }}',
                columns: [
                    {data: 'faq_id', name: 'faq_id'},
                    {data: 'faq_titulo', name: 'faq_titulo'},
                    {data: 'faq_ordem', name: 'faq_ordem'},
