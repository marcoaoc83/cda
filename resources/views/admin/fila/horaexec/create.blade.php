<!-- Modal -->
<div id="myModalHoraExec" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formHoraExec"  class="form-horizontal form-label-left" >
                    {{ csrf_field() }}
                    <input type="hidden" name="FilaTrabId" value="{{$Fila->FilaTrabId}}">
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="DiaSemId">Dia<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select class="form-control" id="DiaSemId" name="DiaSemId" required="required">
                                <option value=""></option>
                                            @foreach($DiaSem as $var)
