        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Listagem de Filas</h2>
                            <a href="{{route('fila.create')}}" style="margin-left: 15px" type="button" class="btn btn-success btn-sm ">
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function deleteFila(dataId) {
            swal({
                title             : "Tem certeza?",
                text              : "Esta Fila será deletado!",
                type              : "warning",
