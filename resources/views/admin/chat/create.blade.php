                            ...
                            <form class="form-horizontal form-label-left"    method="post" action="{{ route('chat.store') }}">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input value="" id="name" class="form-control col-md-7 col-xs-12 text-lowercase" data-validate-length-range="6" data-validate-words="2" name="name"  required="required" type="text">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input value="" id="description" class="form-control col-md-7 col-xs-12 " data-validate-length-range="6" data-validate-words="2" name="description"  required="required" type="text">
                                    </div>
                                </div>
