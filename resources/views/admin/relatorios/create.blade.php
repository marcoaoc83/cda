                            ...
                            <form class="form-horizontal form-label-left"    method="post" action="{{ route('relatorios.store') }}">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input value="{{ old('rel_titulo') }}" id="rel_titulo" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="rel_titulo"  required="required" type="text">
                                    </div>
                                </div>
