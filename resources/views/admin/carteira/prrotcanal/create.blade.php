<!-- Modal -->
<div id="myModalPrRotCanal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formPrRotCanal"  class="form-horizontal form-label-left" >
                    {{ csrf_field() }}
                    <input type="hidden" name="CarteiraId" value="{{$Carteira->CARTEIRAID}}">
                    <input type="hidden" id="RoteiroId" name="RoteiroId">
