        ...
        <td style="width: 100%; height: 18px;">
            <table style="width: 100%; border-collapse: collapse; border-style: solid; height: 36px;font-size: 12px;" border="1" >
                ...
                <tr style="height: 36px;">
                    ...
                    <td style="width: 25%; border-style: solid; height: 36px;"><strong>DATA DE EMISS&Atilde;O<br /><br /></strong></td>
    ...
    <tr style="height: 18px;">
        <td style="width: 100%; height: 18px;">
            <table style="border-collapse: collapse; width: 100%; height: 36px;font-size: 12px;" border="1">
                <tbody>
                <tr style="height: 36px;">
                    <td style="width: 50%; border-style: solid; height: 36px;"><strong>CONTRIBUINTE / PROPRIET&Aacute;RIO</strong><br /><br /></td>
    ...
    <tr style="height: 18px;">
        <td style="width: 100%; height: 18px;">
            <table style="border-collapse: collapse; width: 100%; height: 36px;font-size: 12px;" border="1">
                <tbody>
                <tr style="height: 36px;">
                    <td style="width: 25%; border-style: solid; height: 36px;"><strong>INSCRI&Ccedil;&Atilde;O</strong><br /><br /></td>
                    <td style="width: 75%; border-style: solid; height: 36px;"><strong>ENDERE&Ccedil;O</strong><br /><br /></td>
                </tr>
                </tbody>
            </table>
        </td>
    ...
    <tr style="height: 18px;">
        <td style="width: 100%; height: 18px;">
            <table style="border-collapse: collapse; width: 100%; height: 36px;font-size: 12px;" border="1">
                <tbody>
                <tr style="height: 36px;">
                    <td style="width: 50.2266%; border-style: solid; height: 36px;"><strong>BAIRRO / LOTEAMENTO</strong><br /><br /></td>
                    <td style="width: 34.4788%; border-style: solid; height: 36px;"><strong>CIDADE / UF</strong><br /><br /></td>
                    <td style="width: 15.2946%; border-style: solid;"><strong>CEP<br /><br /></strong></td>
                </tr>
                </tbody>
            </table>
        </td>
    ...
    <tr style="height: 18px;">
        <td style="width: 100%; height: 18px;">
            <table style="border-collapse: collapse; width: 100%; height: 18px;font-size: 12px;" border="1">
                <tbody>
                <tr style="height: 18px;">
                    <td style="width: 14.2857%; border-style: solid; text-align: center; height: 18px;"><strong>DATA VALIDADE</strong><br /><br /></td>
                    <td style="width: 14.2857%; border-style: solid; text-align: center; height: 18px;"><strong>VALOR LAN&Ccedil;ADO</strong><br /><br /></td>
                    <td style="width: 14.2857%; border-style: solid; text-align: center; height: 18px;"><strong>VALOR ATUALIZADO</strong><br /><br /></td>
                    <td style="width: 14.2857%; border-style: solid; text-align: center; height: 18px;"><strong>MULTA/JUROS</strong><br /><br /></td>
                    <td style="width: 14.2857%; border-style: solid; text-align: center; height: 18px;"><strong>DESCONTO</strong><br /><br /></td>
                    <td style="width: 14.2857%; border-style: solid; text-align: center; height: 18px;"><strong>GRT</strong><br /><br /></td>
                    <td style="width: 14.2857%; border-style: solid; text-align: right; height: 18px;"><strong>TOTAL</strong><br /><br /></td>
                </tr>
                </tbody>
            </table>
        </td>
