...
@section('content')
    <div class="pf-main">
        <div class="container pt-4 pb-4 pl-4 pr-4">
            ...
            <p class="pf-text-muted mb-4">Sobre as principais leis, decretos e documentos que regem a legalidade dos processos de Dívida Ativa do município.</p>

            <div class="row">
                <div class="col-12 col-sm-6 col-lg-3 text-center mb-4">
                    <a href="#" class="pf-td-none">
                        <img src="imgs/ico-legislacao.svg" class="mb-4 mt-4" alt="" />
